...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.ViewHolder> {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        // lav klner stex void bind(CategoryModel model) method grel u onBindViewHolder-ic es funkcian kanchel
        // aysinqn en set-ery stex sra nersum kaneiq + es 2 field-y klnein private :)
